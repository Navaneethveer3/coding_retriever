...
class Student(Base):
    ...
    hr_java_stars = Column(Integer, default=0)
    hr_python_stars = Column(Integer, default=0)
    hr_c_stars = Column(Integer, default=0)
    hr_sql_stars = Column(Integer, default=0)
