    ...
    const categories = [
        {
            ...
            description: 'Early tracking for first year students',
            icon: '👶',
            className: 'year-1',
            uploaded: user?.has_uploaded_1st_year,
        },
        {
            id: '2nd_year',
        ...
        },
        {
            ...
            description: 'Final year performance and placement tracking',
            icon: '🎓',
            className: 'year-4',
            uploaded: user?.has_uploaded_4th_year,
        },
    ];
